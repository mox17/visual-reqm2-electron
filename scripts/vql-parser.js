...
var grammar = {
    ...
    {"name": "or_term", "symbols": ["and_term", "__", "or_term$subexpression$1", "__", "or_term"], "postprocess": (d) => { return {op: "OR", args: [d[0], d[4]] } }},
    ...
    {"name": "and_term", "symbols": ["and_term", "__", "and_term$ebnf$1", "term"], "postprocess": (d) => { return {op: "AND", args: [d[0], d[3]] } }},
